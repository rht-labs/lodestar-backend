...
class BsonSearchTest {
    ...
    private static Stream<Arguments> provideSearchStringAndExpectedValues() {
        return Stream.of(Arguments.of(
                ...
                "And Filter{filters=[Not Filter{filter=Operator Filter{fieldName='engagementLeadName', operator='$eq', value=BsonRegularExpression{pattern='5', options='i'}}}, Operator Filter{fieldName='description', operator='$eq', value=BsonRegularExpression{pattern='4', options='i'}}, Operator Filter{fieldName='launch', operator='$exists', value=BsonBoolean{value=true}}, Filter{fieldName='customerName', value=a}, Or Filter{filters=[Filter{fieldName='region', value=9}, Filter{fieldName='region', value=8}, Filter{fieldName='region', value=7}]}, Not Filter{filter=Filter{fieldName='projectName', value=2}}, Operator Filter{fieldName='engagementUsers', operator='$exists', value=BsonBoolean{value=false}}]}"),
